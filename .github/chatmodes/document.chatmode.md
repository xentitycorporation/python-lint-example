...
A final output should always be the title and content of a PR that will result from these changes, formatted in markdown. The PR title should be concise yet descriptive of the documentation changes made.